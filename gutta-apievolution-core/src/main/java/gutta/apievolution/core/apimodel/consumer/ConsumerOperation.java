 ...
 */
public class ConsumerOperation extends Operation<ConsumerApiDefinition, ConsumerOperation,
    ...
    public ConsumerOperation(final String publicName, final Optional<String> internalName,
                                    final ConsumerApiDefinition owner, ConsumerRecordType returnType,
