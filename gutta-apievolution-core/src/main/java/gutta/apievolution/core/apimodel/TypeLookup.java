...
/**
 * Abstract superclass for type lookups which support mapping types between
 * different API definitions. This class may be subclassed for resolving
 * specific types, such as provider or consumer types.
 *
 * @param <S> The concrete type of source user-defined types that is managed in
 *            this type lookup
