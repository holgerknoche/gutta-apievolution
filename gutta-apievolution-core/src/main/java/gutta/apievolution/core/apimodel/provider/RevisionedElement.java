...
/**
 * Revisioned elements have a history of revisions, represented by predecessors
 * and successors.
 *
...
public interface RevisionedElement<T extends RevisionedElement<T>> {
    ...
    /**
     * Finds the first successor of this revisioned element matching the given
     * predicate.
     *
    ...
    default Optional<T> findFirstSuccessorMatching(Predicate<T> matchPredicate) {
        return this.successorStream(false).filter(matchPredicate).findFirst();
    }

    /**
     * Finds the first predecessor of this revisioned element matching the given
     * predicate.
     *
     * @param matchPredicate The predicate to match
     ...
     * element itself.
     *
     * @param inclusive Denotes whether the element itself should be included in the
     *                  stream
    ...
    /**
     * Returns a stream of all successors of this element, possibly including the
     * element itself.
     *
     * @param inclusive Denotes whether the element itself should be included in the
     *                  stream
