...
public class TestMethod25ProviderProxy extends ProviderProxyTemplate<ProviderResult25> {
	...
	public TestMethod25ProviderProxy(ApiMappingScript consumerToProviderScript,
			ApiMappingScript providerToConsumerScript, FixedFormatMapper mapper, Charset charset) {

		super("testMethod25", ProviderResult25.class, consumerToProviderScript, providerToConsumerScript, mapper,
				charset);
	}
