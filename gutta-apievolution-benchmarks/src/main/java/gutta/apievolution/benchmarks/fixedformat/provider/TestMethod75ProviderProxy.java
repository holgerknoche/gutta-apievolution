...
public class TestMethod75ProviderProxy extends ProviderProxyTemplate<ProviderResult75> {
    ...
    public TestMethod75ProviderProxy(ApiMappingScript consumerToProviderScript, ApiMappingScript providerToConsumerScript, FixedFormatMapper mapper,
            Charset charset) {

        super("testMethod75", ProviderResult75.class, consumerToProviderScript, providerToConsumerScript, mapper, charset);
    }
