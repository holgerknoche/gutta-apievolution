...
/**
 * As the name implies, user-defined types (UDTs) are types that are given by the user. Examples of such types are record and
 * enumeration types.
 *
...
public abstract class UserDefinedType<A extends ApiDefinition<A>> extends ApiDefinitionElement implements Type {
	 ...
	 */
	protected UserDefinedType(final String publicName, final Optional<String> internalName, final int typeId, final A owner) {
