...
class FixedFormatMapperTest {
    ...
    void serializeStringWithPadding() {
        ...
        byte[] expectedBytes = new byte[] {0x01, 0x54, 0x65, 0x73, 0x74, 0x54, 0x65, 0x73, 0x74, 0x00, 0x00};
    ...
    void serializeMatchingString() {
        ...
        byte[] expectedBytes = new byte[] {0x01, 0x54, 0x65, 0x73, 0x74, 0x54, 0x65, 0x73, 0x74, 0x54, 0x65};
