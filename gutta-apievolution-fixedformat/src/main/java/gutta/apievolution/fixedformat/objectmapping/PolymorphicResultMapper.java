...
class PolymorphicResultMapper extends AbstractRecordTypeMapper {
    ...
    public PolymorphicResultMapper(TypeMapper<?> resultTypeMapper, Map<Integer, RecordTypeMapper> resultTypeMappers, Map<Integer, RecordTypeMapper> exceptionTypeMappers) {
    ...
    private static Map<Integer, MappingInfo> buildMappingInfo(Map<Integer, RecordTypeMapper> resultTypeMappers, Map<Integer, RecordTypeMapper> exceptionTypeMappers) {
